...
class OutputNeuron(Neuron):
    ...
    def incremental_semantics_update(self, num_last_connections, clip_weighted_input=False):
        ...
        if clip_weighted_input:
            self.weighted_input = self.weighted_input.clip(0, 1)
