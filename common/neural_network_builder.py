...
class NeuralNetworkBuilder:
    ...
    def generate_new_neural_network(number_hidden_layers,
        ...
        input_layer, hidden_layers, output_layer = NeuralNetworkBuilder.connect_neural_network(input_layer, hidden_layers, output_layer,
                                                                                               maximum_neuron_connection_weight, random_state,
                                                                                               sparseness)
    ...
    def connect_neural_network(input_layer, hidden_layers, output_layer, maximum_neuron_connection_weight, random_state, sparseness):
        ...
        hidden_layers[0] = NeuralNetworkBuilder.connect_layers(layer_to_connect=hidden_layers[0], previous_layer=input_layer,
        ...
        for i, hidden_layer in enumerate(hidden_layers[1:]):
            ...
            hidden_layer = NeuralNetworkBuilder.connect_layers(layer_to_connect=hidden_layer, previous_layer=hidden_layers[i],
                                                               ...
                                                               sparseness=sparseness, neurons_for_skip_connections=neurons_for_skip_connections)
        ...
        output_layer = NeuralNetworkBuilder.connect_layers(layer_to_connect=output_layer, previous_layer=hidden_layers[-1],
                                                           maximum_neuron_connection_weight=maximum_neuron_connection_weight, random_state=random_state,
