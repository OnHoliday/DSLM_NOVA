...
def get_estimator():
    ...
    estimator = DeepSemanticLearningMachine(1, MaxGenerationsCriterion(iterations), min_cp_layers, max_cp_layers, cnn_neurons_per_layer, min_ncp_layers, max_ncp_layers, init_last_hidden_layer_neurons, mutation_last_hidden_layer_neurons, conv_prob)
    return estimator
