...
DEFAULT_NUMBER_OF_COMBINATIONS = 5

DEFAULT_POPULATION_SIZE = 10
DEFAULT_NUMBER_OF_ITERATIONS = 5


def generate_random_slm_bls_configuration(option=None, init_maximum_layers=5, maximum_iterations=5, maximum_learning_step=10, maximum_neuron_connection_weight=0.5, maximum_bias_connection_weight=1.0, mutation_maximum_new_neurons_per_layer=3):
    configuration = {}
...
def generate_random_slm_ols_configuration(option=None, init_maximum_layers=3, maximum_iterations=5, maximum_neuron_connection_weight=0.5, maximum_bias_connection_weight=1.0, mutation_maximum_new_neurons_per_layer=3):
...
def generate_random_slm_lr_ls_configuration(init_maximum_layers=5, maximum_iterations=5, maximum_neuron_connection_weight=0.5, maximum_bias_connection_weight=1.0, mutation_maximum_new_neurons_per_layer=3):
...
def generate_random_1_1_slm_ols_configuration(init_maximum_layers=5, maximum_iterations=5, maximum_neuron_connection_weight=0.5, maximum_bias_connection_weight=1.0, mutation_maximum_new_neurons_per_layer=3):
    configuration = generate_random_slm_ols_configuration(init_maximum_layers=init_maximum_layers, maximum_iterations=maximum_iterations, maximum_neuron_connection_weight=maximum_neuron_connection_weight, maximum_bias_connection_weight=maximum_bias_connection_weight, mutation_maximum_new_neurons_per_layer=mutation_maximum_new_neurons_per_layer)
    configuration['population_size'] = 1
    return configuration


def generate_random_1_5_slm_ols_configuration(init_maximum_layers=5, maximum_iterations=5, maximum_neuron_connection_weight=0.5, maximum_bias_connection_weight=1.0, mutation_maximum_new_neurons_per_layer=3):
    configuration = generate_random_slm_ols_configuration(init_maximum_layers=init_maximum_layers, maximum_iterations=maximum_iterations, maximum_neuron_connection_weight=maximum_neuron_connection_weight, maximum_bias_connection_weight=maximum_bias_connection_weight, mutation_maximum_new_neurons_per_layer=mutation_maximum_new_neurons_per_layer)
    configuration['population_size'] = 5
    return configuration

def generate_random_1_10_slm_ols_configuration(init_maximum_layers=5, maximum_iterations=5, maximum_neuron_connection_weight=0.5, maximum_bias_connection_weight=1.0, mutation_maximum_new_neurons_per_layer=3):
