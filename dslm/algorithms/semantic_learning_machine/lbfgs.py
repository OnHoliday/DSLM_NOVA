...
class LBFGS:
    ...
    def fit(self, X, y, activations, deltas, coef_grads, intercept_grads, layer_units, random_state=None, coef_init=None, intercept_init=None, init_bound=1, fixed_weighted_input=None):
        self.n_iter_ = 0
