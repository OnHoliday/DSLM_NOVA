...
class SemanticLearningMachine(EvolutionaryAlgorithm):
    ...
    def _initialize_hidden_layers(self, neural_network):
        ...
        hidden_layers = [[create_neuron(None, neural_network.bias, maximum_bias_connection_weight=self.maximum_bias_connection_weight) for _ in range(neurons_per_layer[layer])] for layer in range(number_of_layers - 1)]
...
# Each mutation can add elements either to existing line or next one ( net is like tree )
    ...
    def _initialize_hidden_layers(self, neural_network):
        ...
        hidden_layers = [[create_neuron(None, neural_network.bias,
                                        maximum_bias_connection_weight=self.maximum_bias_connection_weight) for _
