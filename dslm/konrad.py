...
from algorithms.common.metric import Cross_entropy, Multiclass_Accuracy
...
def generalization_benchmark2(dataset_name):
    ...
    benchmarker = Benchmarker(dataset_name, models=models_to_run, benchmark_id='slm_generalization', file_path='D:\SLM_CNN\cifar-10-batches-py', learning_metric=Cross_entropy, selection_metric=Cross_entropy)
